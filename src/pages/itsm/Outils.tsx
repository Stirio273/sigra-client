...
import { applicationService, classeServiceService } from "@/services/application.service";
      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="mt-6 space-y-4">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-medium">Configuration des Applications</h1>
        ...
        <DialogContent className="w-full max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {deleteTarget?.libelle}" ? Cette action est irréversible.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
